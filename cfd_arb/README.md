...
| ├── broker_config.json    #mt5 terminal and broker setup configuration
├── data/
...
- All config is managed in the `config/` directory:
    - `broker_config.json` for broker connection info
    - `asset_config.yml` for asset parameters
